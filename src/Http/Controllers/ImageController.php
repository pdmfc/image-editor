...
class ImageController extends Controller
{
    ...
    private function imageEditRules(bool $forSave = false): array
    {
        $rules = [
            ...
            'texts.*.box_border_color' => 'nullable|string|max:32',
            'texts.*.box_border_width' => 'nullable|integer|min:0|max:12',
            'texts.*.box_border_padding' => 'nullable|integer|min:0|max:48',
            'texts.*.box_width' => 'nullable|integer|min:24|max:20000',
            ...
            'image_overlays.*.caption' => 'nullable|array',
            'image_overlays.*.caption.number' => 'required_with:image_overlays.*.caption|integer|min:1|max:9999',
            'image_overlays.*.caption.description' => 'nullable|string|max:2000',
            'image_overlays.*.caption_angle' => 'nullable|integer|min:0|max:359',
            'caption_settings' => 'nullable|array',
            'caption_settings.prefix' => 'nullable|string|max:40',
            'caption_settings.separator' => 'nullable|string|max:10',
            'caption_settings.font_size' => 'nullable|integer|min:8|max:120',
            'caption_settings.band_padding' => 'nullable|integer|min:4|max:80',
            'caption_settings.color' => 'nullable|string|max:32',
            'caption_settings.bold' => 'sometimes|boolean',
            'caption_settings.band_border_width' => 'nullable|integer|min:0|max:12',
            'caption_settings.band_border_color' => 'nullable|string|max:32',
            'caption_settings.band_border_canvas' => 'sometimes|boolean',
            'caption_settings.band_border_all_overlays' => 'sometimes|boolean',
            'image_overlays.*.caption_band_border' => 'sometimes|boolean',
            'photo_caption' => 'nullable|array',
            'photo_caption.enabled' => 'sometimes|boolean',
            'photo_caption.number' => 'nullable|integer|min:1|max:9999',
            'photo_caption.description' => 'nullable|string|max:2000',
